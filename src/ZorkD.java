...
public class ZorkD {
    ...
    public static void main(String[] args){
        ...
        while(!dir.equals("q")){
            if (roomNo == npc) {
                System.out.println("Oh no! You stumble across the path of a giant mountain troll! " +
                        "It picks you up by the leg and shakes you so that all of your coins fall out of your pockets. " +
                        "It drops you to the ground and runs away with all of your money. You just got mugged by a mountain troll!");
                userCoins = 0;
            }
